...
CLUSTER_DESC = {
    ...
    2: "Grandes pérdidas económicas pero respuesta muy rápida (PC2 alto). Pocos muertos y recuperación acelerada. Típico de países desarrollados ante catástrofes costosas."
}
...
# ── PÁGINA: CLUSTERING ────────────────────────────────────────────────────────
    ...
    profiles = [
        ...
        ("🔴 Cluster 1", "Alto impacto humano / Gestión deficiente", "#fc8181",
         "Alta mortalidad · Respuesta muy tardía (domina PC1) · Pérdidas elevadas · Meses de recuperación"),
        ("🟡 Cluster 2", "Alto daño económico / Respuesta eficiente", "#f6ad55",
         "Grandes pérdidas económicas · Respuesta rapidísima (PC2 alto) · Pocos muertos · Recuperación acelerada"),
    ]
...
# ── PÁGINA: COMPARATIVA DE MODELOS ────────────────────────────────────────────
    ...
    with col1:
        ...
        <p>A pesar del Silhouette bajo (datos sintéticos con solapamiento), KMeans con k=3 ofrece la mejor interpretabilidad. Los clusters tienen sentido confirmado por el PCA:<br>
        <b>PC1</b> (casualties 0.67, response_hours 0.57) separa el cluster rojo hacia la derecha.<br>
        <b>PC2</b> (economic_loss +0.81 vs response_hours −0.55) eleva el cluster amarillo: mucho daño económico, respuesta rápida.</p>
        </div>
        """, unsafe_allow_html=True)
    with col2:
